...
_REPO_STARTER_COMMIT=4afe852

# The short commit hash each tag should be on
_ANALYZED_COMMIT=bedb6c1
_DESIGNED_COMMIT=f1a3823
_IMPLEMENTED_COMMIT=b9ca458
_TESTED_COMMIT=f505f09
...
prologue() {
	...
	* git push
	...
	$(ylw "An internet connection is required for this lesson.")
